...
class AddNewNote:
    ...
    def initUI(self,dash,db):
        ...
        self.root.title("Create a New Note")
        self.Font = font.Font(family='Helvetica', size=15, weight='bold')
        self.Font_search_text = font.Font(family='Helvetica', size=15)
        self.Font_search_btn = font.Font(family='Helvetica', size=15, weight='bold')
        self.Font_note = font.Font(family='Helvetica', size=18)
        self.add_label=Label(self.root,text="Add New Notes Below",font=self.Font)
        self.add_label.place(x=170,y=15,weight='bold')
        self.text = Text(self.root,font=self.Font_note,width=55,height=18,weight='bold')
